---
title: Mickey
desc: Mickey - минимальный одноколоночный шаблон для Jekyll.
...
![Mickey screenshots](https://github.com/vincentchan/mickey/blob/master/assets/images/demo.png?raw=true)
