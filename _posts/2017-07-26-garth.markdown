---
title: Garth
desc: A stupidly simple theme for Jekyll, using the official Jekyll theme implementation.
...
![Screenshot](https://raw.githubusercontent.com/daviddarnes/garth/master/screenshot.png?raw=true)
